...
✦ **cadaver dissection (medic apprentices)**: `/medic action:dissect` lets an apprentice study a dead packmate to learn anatomy — it needs an **alpha** or **full medic** in the den to sanction the training; once per sunrise, up to 3 lessons total; a passed medicine check deepens the **medicine** skill (a natural 1 nicks a rib and risks infection). it is solemn medical work that costs **−5 mood** each time and **notifies the fallen wolf's player**. it's *how* a medic comes to understand the organs a random wolf only feels as symptoms  
