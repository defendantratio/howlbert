...
✦ **cadaver dissection (medic apprentices)**: `/medic action:dissect` lets an apprentice study a dead packmate to learn anatomy — once per sunrise, up to 3 lessons total; a passed medicine check deepens the **medicine** skill (a natural 1 nicks a rib and risks infection), but it is grim, taboo work that costs **−5 mood** every time. it's *how* a medic comes to understand the organs a random wolf only feels as symptoms  
