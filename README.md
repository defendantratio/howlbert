...
✦ **vomiting and cumulative organ damage**: nauseating herbs eaten internally can be **thrown back up** on a failed con save (−8 hunger, −6 hydration, −3 mood); and the "long-term use" warnings now bite — repeated internal doses of an organ-straining herb are tallied for life, and past a threshold become a **permanent long-term condition** shown on `/vitals` (Weak-Heart from potassium-wasting diuretics, Rot-Kidney, Bile-Rot, or The Trembles from thiamine loss), each a −1 to the relevant checks. vary your herbs  
