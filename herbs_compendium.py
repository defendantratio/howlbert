...
HERBS = {
    ...
    "arnica": _h(
        ...
        preparation="external use only; chewed into a poultice or rubbed on as ointment.",
    ),
    "beech_leaves": _h(
        "Beech Leaves",
        "common",
    ...
    "bindweed": _h(
        "Bindweed Vines",
        "common",
        "relieves gut complaints and urinary problems; immune-stimulating tea for fever. tough vines lash splints to broken bones, speeding supported breaks (bone healing minus 7 days). strong laxative in large amounts; use sparingly.",
    ...
    "boneset": _h(
        ...
        preparation="leaves and flowers eaten fresh or dried.",
    ),
    "borage": _h(
        "Borage",
        "common",
    ...
    "burnet": _h(
        ...
        preparation="applied as poultice; root used as astringent tea.",
    ),
    "catchweed": _h(
        "Catchweed Burrs",
        "common",
    ...
    "chickweed": _h(
        ...
        preparation="used as tea or poultice application.",
    ),
    "cobnuts": _h(
        "Cobnuts",
        "common",
    ...
    "elder": _h(
        ...
        preparation="bark and leaf prepared as a poultice; requires careful preparation, unripe or uncooked parts are toxic.",
    ),
    "elderberry": _h(
        "Elderberry",
        "rare",
        ...
        packs=("mistmoor",),
        cures=("distemper", "influenza", "leafbare_cough"),
    ...
    "feverfew": _h(
        ...
        preparation="fresh or dried leaf eaten.",
    ),
    "foxglove": _h(
        "Foxglove",
        "restricted",
    ...
    "goldenrod": _h(
        ...
        preparation="tea, or poultice from bruised leaves.",
    ),
    "heather": _h(
        "Heather",
        "common",
        ...
        preparation="tender tops and flowers made into tea; roots in milk for diarrhea.",
    ),
    "holly_berries": _h(
        "Holly Berries",
        "restricted",
    ...
    "knotgrass": _h(
        ...
        preparation="eaten fresh several times a day; tea for kidney and bladder conditions.",
        prep_methods=("poultice", "tea"),
    ),
    "labrador_tea": _h(
        "Labrador Tea",
        "common",
    ...
    "meadowsweet": _h(
        ...
        preparation="tea from the flower or dried herb.",
    ),
    "mountain_ash": _h(
        "Mountain Ash (Rowan)",
        "common",
    ...
    "passionflower": _h(
        ...
        preparation="tea from the dried vine and flower.",
    ),
    "pine_needle": _h(
        "Pine Needles",
        "common",
        ...
        preparation="tea from fresh or dried needles.",
    ),
    "pine_bark": _h(
        "Pine Bark",
        "common",
        ...
        preparation="inner bark chewed or steeped as tea.",
    ),
    "plantain": _h(
        "Plantain",
        "uncommon",
        ...
        preparation="tea, or leaves chewed into a poultice.",
    ),
    "poison_ivy": _h(
        "Poison Ivy",
        "restricted",
    ...
    "raspberry_leaves": _h(
        "Raspberry Leaves",
        "common",
        "advantage on birth hemorrhage saves; rich in vitamins and minerals. strongly astringent; eases mild diarrhea and chest cough. detoxifying tea.",
    ...
    "mugwort": _h(
        ...
        preparation="tea, rubbed through the pelt; use with caution.",
    ),
    "garden_mint": _h(
        "Garden Mint",
        "common",
    ...
    "wood_sorrel": _h(
        ...
        preparation="small amounts as tea; poultice.",
    ),
    "oxeye_daisy": _h(
        "Oxeye Daisy",
        "common",
    ...
    "garlic_mustard": _h(
        "Garlic Mustard",
        "common",
        "rub through pelt to drive off fleas; antiseptic poultice for infected bites and wounds; neutralizes mild poison; eases leaf-bare cough and lyme; kills gut worms over several days.",
        habitat=("roadside",),
        cures=("leafbare_cough", "infected_wound", "mild_poison", "lyme", "worms"),
        side_effects="safe in moderate amounts; large quantities may cause digestive discomfort; contains goitrogens.",
        preparation="young leaves eaten; poultice; rubbed through the pelt for fleas.",
    ),
}