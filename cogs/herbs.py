...
class Herbs(commands.Cog):
    ...
    @app_commands.describe(action='guide, prepare, dryall, store, or turnin', herb='inventory herb key (`herb_arnica`)', herb_filter='habitat filter for guide', prep_method='dry, poultice, tea, and more (prepare)', mode='store: list, deposit, depositall, withdraw, or withdrawall', store_stack='store stack id to withdraw or turn in')
