...
from utils.herb_autocomplete import herb_inventory_autocomplete, store_stack_autocomplete
...
class Herbs(commands.Cog):
    ...
    @app_commands.describe(action='guide, prepare, dryall, store, or turnin', herb='inventory herb key (`herb_arnica`)', herb_filter='habitat filter for guide', prep_method='dry, poultice, juice, tea, and more (prepare)', mode='store: list, deposit, depositall, withdraw, or withdrawall', store_stack='store stack id to withdraw or turn in')
    @app_commands.choices(action=[app_commands.Choice(name='herb guide / compendium', value='guide'), app_commands.Choice(name='prepare herb', value='prepare'), app_commands.Choice(name='dry all (inventory + den store)', value='dryall'), app_commands.Choice(name='den herb store', value='store'), app_commands.Choice(name='turn in poison herbs', value='turnin')], herb_filter=[app_commands.Choice(name='all herbs', value='all'), app_commands.Choice(name='territory (wild)', value='wild'), app_commands.Choice(name='thunderpath verge', value='roadside'), app_commands.Choice(name='twoleg compound edge', value='compound')], prep_method=[app_commands.Choice(name='dry for storage', value='dry'), app_commands.Choice(name='poultice (chewed leaves)', value='poultice'), app_commands.Choice(name='juice (pressed)', value='juice'), app_commands.Choice(name='eaten raw', value='raw'), app_commands.Choice(name='tea (steeped)', value='tea'), app_commands.Choice(name='gargle', value='gargle'), app_commands.Choice(name='sweeten (tea/gargle + honey)', value='sweeten'), app_commands.Choice(name='ointment (salve)', value='ointment'), app_commands.Choice(name='sap (pressed)', value='sap'), app_commands.Choice(name='rub (pelt rub)', value='rub'), app_commands.Choice(name='eaten cooked', value='cook'), app_commands.Choice(name='simmered in milk', value='milk')], mode=[app_commands.Choice(name='list store', value='list'), app_commands.Choice(name='deposit herb', value='deposit'), app_commands.Choice(name='deposit all herbs', value='depositall'), app_commands.Choice(name='withdraw herb', value='withdraw'), app_commands.Choice(name='withdraw all herbs', value='withdrawall')])
    @app_commands.autocomplete(herb=herb_inventory_autocomplete, store_stack=store_stack_autocomplete)
