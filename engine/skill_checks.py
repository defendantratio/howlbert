...
_reg(
    ...
    _s("track_recent", "Follow recent trail (1 to 6 hours)", "tracking", 12, "tracking", ("attr_int",), "Tracking",
       "Scent line holds through brush.", "Trail too cold to pay out."),
    _s("track_cold", "Follow cold trail (6 to 24 hours)", "tracking", 15, "tracking", ("attr_int",), "Tracking",
       "Patient work; the trail opens.", "Lost the thread."),
    _s("track_very_cold", "Follow very cold trail (1 to 3 days)", "tracking", 18, "tracking", ("attr_int",), "Tracking",
    ...
    _s("track_count_smell", "Count wolves by smell alone", "tracking", 12, "tracking", ("attr_int",), "Tracking",
       "You count hearts by stink and breath.", "Wrong count (off by 1 to 3); could be a trap."),
...
_reg(
    ...
    _s("prep_mix_tonic", "Mix tea without contamination", "herb_prep", 12, "herblore", ("attr_int",), "Herblore",
       "Clean tea.", "Contaminated; half effect or vomit."),
    ...
    _s("prep_decoct", "Steep tea in hot spring water", "herb_prep", 15, "herblore", ("attr_int",), "Herblore",
